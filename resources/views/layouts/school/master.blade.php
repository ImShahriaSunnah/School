    ...
    <aside class="sidebar-wrapper">
        ...
        <div class="textmenu">
            ...
            <div class="tab-content">
                ...
                {{-- Dashboard --}}
                <div class="tab-pane fade <?php if ((Request::segment(1) == 'school' and Request::segment(2) == 'dashboard')
                OR (Request::segment(2) == 'online' and Request::segment(3) == 'admission')
                OR (Request::segment(1) == 'school' and Request::segment(2) == 'profile')) {
                    echo 'active show';
                ...
                <div class="tab-pane fade @if(Request::segment(1) == 'school' and Request::segment(2) == 'staff') active show @endif " id="pills-staff">
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{route('school.staff.show')}}" class="list-group-item"><i class="fadeIn animated bx bx-male"></i>{{__('app.Stuff')}}  {{__('app.Type')}} </a>
                ...
                <div class="tab-pane fade <?php if (Request::segment(1) == 'school' and Request::segment(2) == 'SchoolAddon') {
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{route('SchoolAddon')}}" class="list-group-item"><i class="bi bi-boxes"></i>{{__('app.Addon')}}</a>
                    </div>
                </div>
                ...
                <div class="tab-pane fade <?php if (Request::segment(1) == 'school' and Request::segment(2) == 'student' and Request::segment(3) == 'notice') {
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="{{route('notice.school.admin.create.show')}}" class="list-group-item"><i class="bi bi-boxes"></i>{{__('app.Notice')}}</a>
                    </div>
                </div>
