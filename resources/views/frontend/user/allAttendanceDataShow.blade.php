...
@section('content')
    ...
    <main class="page-content">
        <div class="row">
            ...
            <div class="col-md-7">
                <form method="get" action="{{route('allAttendance.show.all.user',['class_id'=>Auth::user()->class_id,'section_id'=>Auth::user()->section_id,'group_id'=>is_null(Auth::user()->group_id) ? 0 :Auth::user()->group_id])}}" enctype="multipart/form-data">
