...
<main class="page-content">
    ...
    <center>
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Change Book Details</h5>
                    ...
                    <form action="{{route('books.edit.post',$booksEdit->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select  class="form-control mb-3 js-select" name="book_type_id" value="{{$booksEdit->book_type_id}}" id="book_type_id" class="form-control">
                                ...
                                <option value="{{$book->id}}" selected>{{$book->book_type}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <img width="200px"  src="{{url('/uploads/library',$booksEdit->image)}}" alt="">
