                    ...
                    <div class="border p-3 rounded">
                        ...
                        <form class="row g-3" method="post" action="{{ route('school.staff.List.create.post') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" required class="form-control" placeholder="{{ __('app.EmployeeName') }}" name="employee_name"  value="{{old('employee_name')}}">
                            </div>
                            <div class="col-12">
                                <label class="form-label">{{ __('app.phone') }} <span style="color:red;">*</span></label>
                                <input type="integer" class="form-control" placeholder=" {{ __('app.phone') }}" name="phone_number" required value="{{old('phone_number')}}">
                            </div>
                            <div class="col-12">
                                <label class="form-label">{{ __('app.EmployeeId') }} <span style="color:red;">*</span></label>
                                <input type="text" class="form-control" placeholder="{{ __('app.EmployeeId') }}" name="employee_id" required value="{{old('employee_id')}}">
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" required placeholder="{{ __('app.Address') }}" name="address" value="{{old('address')}}">
                            </div>
                            <div class="col-12">
                                <label class="form-label">{{ __('app.Salary') }}<span style="color:red;">*</span></label>
                                <input type="text" class="form-control" required placeholder="{{ __('app.Salary') }}" name="salary" value="{{old('salary')}}">
                            </div>
                            <div class="col-12">
                                <div class="d-grid">
                        ...
                        @else
                        <form class="row g-3" method="post" action="{{ route('school.staff.List.create.update', $employeeEdit->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12">
                                @include('frontend.layouts.message')
                            </div>
                            <div class="col-12">
                                <label class="form-label">{{ __('app.EmployeeName') }} <span style="color:red;">*</span></label>
                                <input type="text" class="form-control" required placeholder="{{ __('app.EmployeeName') }}" name="employee_name" value="{{ $employeeEdit->employee_name }}" required>
                            </div>
                            <div class="col-12">
                                <label class="form-label">{{ __('app.phone') }} <span style="color:red;">*</span></label>
                                <input type="integer" class="form-control" required placeholder="{{ __('app.phone') }}" name="phone_number" value="{{ $employeeEdit->phone_number }}" required>
                            </div>
                            <div class="col-12">
                                <label class="form-label">{{ __('app.EmployeeId') }} <span style="color:red;">*</span></label>
                                <input type="text" class="form-control" required placeholder="{{ __('app.EmployeeId') }}" name="employee_id" value="{{ $employeeEdit->employee_id }}" required>
                            </div>
                            <div class="col-12">
                                <label class="form-label">{{ __('app.Gender') }} <span style="color:red;">*</span></label>
                                <select class="form-control mb-3 js-select" required name="gender" required type="text" id="">
                                    <option value="">{{ __('app.select') }}</option>
                            ...
                            <div class="col-12">
                                <label class="form-label">{{ __('app.PositionName') }} <span style="color:red;">*</span></label>
                                <select class="form-select mb-3" aria-label="Default select example" name="position_name" required>
                                    @foreach ($position as $data)
                                    <option value="{{ $data->position_name }}" {{ $data->position_name == $employeeEdit->position ? 'selected' : '' }}>
                                        {{ $data->position_name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12">
                                <label class="form-label">{{ __('app.Address') }}<span style="color:red;">*</span></label>
                                <input type="text" required class="form-control" placeholder="{{ __('app.Address') }}" name="address" value="{{ $employeeEdit->address }}">
                            </div>
                            <div class="col-12">
                                <label for="">{{ __('app.Shift') }}</label>
                            ...
                            <div class="col-12">
                                <label class="form-label">{{ __('app.Salary') }}<span style="color:red;">*</span></label>
                                <input type="text" required class="form-control" placeholder="{{ __('app.Salary') }}" name="salary" value="{{ $employeeEdit->salary }}">
                            </div>
