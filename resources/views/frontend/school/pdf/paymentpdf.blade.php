            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-invoice">
                        ...
                        <tr>
                            <td>
                                <span class="text-inverse">{{$data->payment_amount}}</span><br>
                                <small></small>
                            </td>
                            <td>
                                <span class="text-inverse">{{Auth::user()->phone_number}}</span><br>
                                <small></small>
                            </td>
                            <td>
                                <span class="text-inverse">{{$data->payment_type}}</span><br>
                                <small></small>
                            </td>
                            <td>
                                <span class="text-inverse">{{$data->payment_amount}}</span><br>
