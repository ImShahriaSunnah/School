...
<div class="col-md-12">
    ...
    <div class="col-md-12">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">MESSAGE PAYMENT STATEMENT</div>
            <div class="ps-3">
            ...
            <div class="ms-auto">
                <div class="btn-group mt-3">
                    <a href="{{route('school.dashboard')}}" class="btn btn-sm btn-outline-success me-2">Home</a>
        ...
        <div class="card border shadow-none">
                ...
                <div class="row row-cols-1 row-cols-lg-3">
                    <div class="col">
                        <div class="">
                            ...
                            <address class="m-t-5 m-b-5">
                                <strong class="text-inverse">{{Auth::user()->school_name}}</strong><br>
                    ...
                    <div class="col">
                        <div class="">
                            <small>to</small>
                            <address class="m-t-5 m-b-5">
                                <strong class="text-inverse">Codecell Limited</strong><br>
                                Phone:+8801676772959 <br>
                                Address: Kamarpara, Turag, Road - 06, House - 27 1230 Dhaka, Dhaka Division, Bangladesh
                            </address>
                        </div>
                    </div>
                    <div class="col">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-invoice">
                        ...
                        <tr>
                            <td>
                                <span class="text-inverse">{{$data->package_name}}</span><br>
                                <small></small>
                            </td>
                            <td>
                                <span class="text-inverse">{{$data->gateway_number}}</span><br>
                                <small></small>
                            </td>
                            <td>
                                <span class="text-inverse">{{$data->gateway_type}}</span><br>
                                <small></small>
                            </td>
                            <td>
                                <span class="text-inverse">{{$data->package_price}}</span><br>
                                <small></small>
                            </td>
                        </tr>
                        </tbody>
                ...
                <div class="row bg-light align-items-center m-0">
                    <div class="col col-auto p-4">
                        ...
                        <h4 class="mb-0">TK {{$data->package_price}}</h4>
                    </div>
                    <div class="col col-auto p-4">
                    ...
                    <div class="col col-auto me-auto p-4">
                        <p class="mb-0">Status</p>
                            <h4 class="mb-0">{{($data->status == 1) ? 'PAID' : 'DUE'}}</h4>
                    </div>
                    <div class="col bg-dark col-auto p-4">
                        <p class="mb-0 text-white text-center">TOTAL</p>
                        <h4 class="mb-0 text-white">TK {{$data->package_price}}</h4>
                    </div>
                </div><!--end row-->
                ...
                <!-- begin invoice-note -->
                <div class="my-3">
                    * Make all cheques payable to CodeCell<br>
            ...
            <div class="card-footer py-3">
                ...
                <p class="text-center d-flex align-items-center gap-3 justify-content-center mb-0">
                    <span class=""><i class="bi bi-globe"></i> {{Auth::user()->school_name}}</span>
                    <span class=""><i class="bi bi-telephone-fill"></i> Phone:{{Auth::user()->phone_number}}</span>
                    <span class=""><i class="bi bi-envelope-fill"></i> {{Auth::user()->email}}</span>
                </p>
            </div>
        </div>
