...
<body>
<?php
    // $amount_data = ( getschoolPayment() * getPackagePrice(workPlace()->price_id)->price ) - getSchoolCheckout();
?>
                    ...
                    <div class="amarPay__left bg-primary">
                        ...
                        <ul class="pt-4">
                            <li class="d-flex justify-content-between text-light my-4">
                                {{-- <span>{{($amount_data > 0) ? 'Due' : 'Balance' }}</span> <span class="fw-bolder">{{($amount_data > 0) ? $amount_data : 2500 }} BDT</span> --}}
                                <span>Payment</span> <span class="fw-bolder">{{ workPlace()?->payment_amount }} BDT</span>
                            </li>
                            {{-- <li class="d-flex justify-content-between text-light my-4">
                                <span>Package Name</span> <span class="fw-bolder">{{getPackagePrice(workPlace()->price_id)?->name}}</span>
                            </li> --}}
                            <li class="d-flex justify-content-between text-light my-4">
                    ...
                    <div class="amarPay__right">
                        ...
                        <div class="text-center">
                            ...
                            <input
                                ...
                                class="amarPay__right__input"
                                type="number"
                                name="pay_amount" value="{{(workPlace()?->payment_amount > 0) ? workPlace()?->payment_amount : 0 }}"
                            />
