...
<main class="page-content">
    ...
    <div class="row">
                            ...
                            <form action="{{ route('expense.list')}}" method="GET" id="orderIdForm">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <a href="{{route('expense.list')}}" class="btn btn-success">Reset</a>
                                        </div>
        ...
        <div class="card-header">
            ...
            <li class="nav-item">
                    <a class="nav-link active" aria-current="true" data-bs-toggle="tab" href="#result"> Expense</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#Profile">Teacher Salary</a>
                </li>
                <li class="nav-item">
