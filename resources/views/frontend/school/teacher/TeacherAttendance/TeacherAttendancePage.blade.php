    ...
    <div class="row">
            ...
            <div class="card" style="box-shadow:4px 3px 13px  .7px #deaaf7;border-radius:5px">
                <div class="card-header py-3 bg-transparent">
                    <div class="d-sm-flex align-items-center">
                        ...
                        <h5 class="mb-2 mb-sm-0"> &nbsp;{{__('app.Date')}}: {{$formattedDate}}</h5>
        ...
        <div class="row my-3 float-right">
            <div class="col-12 d-flex justify-content-center">
                <button class="btn btn-primary btn-sm mb-2" title="{{__('app.Print')}}" onclick="printDiv()" ><i class="bi bi-printer"></i></button>            </div>
        </div>
    </div>
    <!--end row-->
