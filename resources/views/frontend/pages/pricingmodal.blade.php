                        ...
                        <div class="amarPay__left bg-primary">
                            ...
                            <ul class="pt-4">
                                <li class="d-flex justify-content-between text-light my-4">
                                    <span>Amount</span> <span class="fw-bolder">{{ $price->price }}
                                        BDT</span>
                                    <input type="hidden" name="price" value="{{ $price->price }}">
                                    <input type="hidden" name="month" value="{{ $price->month }}">
                                    <input type="hidden" name="title" value="{{ $price->title }}">
                                </li>
                                <li class="d-flex justify-content-between text-light my-4">
                                    <span>Package Name</span> <span class="fw-bolder">{{ $price->title }}</span>
                                </li>
                                <li class="d-flex justify-content-between text-light my-4">
                                    <span>Month</span>
                                    <span class="fw-bolder">{{ $price->month }}</span>
                                </li>
                                <li class="d-flex justify-content-between text-light my-4">
                        ...
                        <div class="amarPay__right">
                                ...
                                <div class="d-flex justify-content-center">
                                    <div class="amarPay__right_img-radio">
                                        <img class="amarPay__right__payImg"
                                            ...
                                            alt="" />
                                        <input class="form-control-radio" type="radio" id="control_01" name="select"
                                            value="bkash" checked />
                                    </div>
                                    <div class="amarPay__right_img-radio">
                                        <img class="amarPay__right__payImg"
                            ...
                            /> --}}
                                ...
                                <input placeholder="Pay Amount" class="amarPay__right__input" type="text"
                                    name="pay_amount" value="{{ $price->price }}" readonly />
