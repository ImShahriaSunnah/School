                                ...
                                <form method="post" action="{{route('signup.post')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="sign__input-wrapper mb-25">
                                        ...
                                        <div class="sign__input">
                                            <input type="text" placeholder="{{__('app.sign1')}}" name="school_name" value="{{ old('school_name') }}" required>
                                    ...
                                    <div class="sign__input-wrapper mb-25">
                                        ...
                                        <div class="sign__input">
                                            <input type="text" placeholder="{{__('app.sign1')}}" name="school_name_bn" value="{{ old('school_name_bn') }}" required>
                                            <i class="fal fa-building"></i>
                                        </div>
                                    </div>
                                    <div class="sign__input-wrapper mb-25">
                                        <h5>{{__('app.sign2')}}</h5>
                                        <div class="sign__input">
                                            <input type="email" placeholder="{{__('app.sign2')}}" name="email" value="{{ isset($email) ? $email : '' }}">
                                    ...
                                    <div class="sign__input-wrapper mb-25">
                                        <h5>{{__('app.sign3')}}</h5>
                                        <div class="sign__input">
                                            <input type="text" placeholder="{{__('app.sign3')}}"  name="phone_number" min="11" max="11" value="{{ old('phone_number') }}" required>
                                    ...
                                    <div class="sign__input-wrapper mb-25">
                                        <h5>{{__('app.sign5')}}</h5>
                                        <div class="sign__input">
                                            <input type="password" placeholder="{{__('app.sign5')}}" name="password">
                                            <i class="fal fa-lock"></i>
                                        </div>
                                    </div>

                                    <button class="w-btn w-btn-11 w-100" type="submit"> <span></span>{{__('app.sign')}}</button>
