        ...
        <div class="container" style="max-width: 100%">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    ...
                    <ul class="mt-4">
                        <li class="text-dark my-3 fw-bolder"><img src="{{ asset('frontend/assets/img/projects/right.svg') }}" alt="">{{__('app.ep3')}} </li>
                        <li class="text-dark my-3 fw-bolder"><img src="{{ asset('frontend/assets/img/projects/right.svg') }}" alt="">{{__('app.ep4')}} </li>
                        <li class="text-dark my-3 fw-bolder"><img src="{{ asset('frontend/assets/img/projects/right.svg') }}" alt="">{{__('app.ep5')}} </li>
                    </ul>
                ...
                <div class="col-lg-6">
                    <div id="featureCrm">
                        <img class="w-100 h-100" src="http://shikkha.one/frontend/assets/img/projects/task_management_1.svg" alt="">
                    </div>
    ...
    <section class="trackProgress pt-30">
        <div class="container">
            <div class="title text-center pb-30">
                <small class="fw-bolder" style="color: #7b68ee; text-transform: uppercase">{{__('app.ep7')}} </small>
                <h2>{{__('app.ep8')}} </h2>
            </div>
            <div class="row">
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-xxl-6 offset-xxl-3 col-xl-8 offset-xl-2 col-lg-8 offset-lg-2">
                    <div class="section__title-wrapper section__title-wrapper-2 text-center mb-75 wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <h2 class="section__title section__title-2">{{__('app.ep13')}} </h2>

                    </div>

                </div>
                <small class="fw-bolder text-start py-4" style="color: #7b68ee; text-transform: uppercase">{{__('app.ep14')}} </small>
            </div>
            <div class="row">
                    ...
                    <div class="features__tab">
                        <ul class="nav nav-tabs featureCrm" id="feaTab" role="tablist">
                            <li class="nav-item featureCrmList" role="presentation">
                                ...
                                <h4 class="text-muted" id="sync-tab" data-bs-toggle="tab" data-bs-target="#sync" type="button" role="tab" aria-controls="sync" aria-selected="true">1. <span class="ms-2"> {{__('app.epp')}}</span> </h4>
                            </li>
                            <li class="nav-item featureCrmList" role="presentation">

                                <h4 class="text-muted" id="sync-tab" id="security-tab" data-bs-toggle="tab" data-bs-target="#security" type="button" role="tab" aria-controls="security" aria-selected="false">2. <span class="ms-2"> {{__('app.ep15')}}
</span> </h4>
                            </li>
                            <li class="nav-item featureCrmList" role="presentation">

                                <h4 class="text-muted"  id="multitask-tab" data-bs-toggle="tab" data-bs-target="#multitask" type="button" role="tab" aria-controls="multitask" aria-selected="false">3. <span class="ms-2"> {{__('app.ep16')}}
</span> </h4>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="features__tab-content">
                        <div class="tab-content" id="feaTabContent">
                            ...
                            <div class="tab-pane fade show active" id="security" role="tabpanel" aria-labelledby="security-tab">
                                <div class="features__thumb">
                                    <div class="features__thumb-inner">
                                        <img class="fea-thumb" src="{{ asset('frontend/assets/img/features/home-2/task_management_2.svg') }}" alt="" width="100%" height="100%">
                                        {{-- <img class="fea-sm" src="{{ asset('frontend/assets/img/features/home-2/fea-sm.jpg') }}" alt="">
                                        <img class="fea-sm-2" src="{{ asset('frontend/assets/img/features/home-2/fea-sm-2.jpg') }}" alt=""> --}}
                                        <img class="fea-2-shape" src="{{ asset('frontend/assets/img/icon/features/home-2/features-shape.png') }}" alt="">
                                    </div>
